...
class DashboardService {
  ...
  Future<Dashboard?> assignDashboardToCustomer(
      String customerId, String dashboardId,
      {RequestConfig? requestConfig}) async {
    return nullIfNotFound(
      (RequestConfig requestConfig) async {
  ...
  Future<Dashboard?> unassignDashboardFromCustomer(
      String customerId, String dashboardId,
      {RequestConfig? requestConfig}) async {
    return nullIfNotFound(
      (RequestConfig requestConfig) async {
  ...
  Future<Dashboard?> makeDashboardPublic(String dashboardId,
      {RequestConfig? requestConfig}) async {
    return nullIfNotFound(
      (RequestConfig requestConfig) async {
        var response = await _tbClient.post<Map<String, dynamic>>(
  ...
  Future<Dashboard?> makeDashboardPrivate(String dashboardId,
      {RequestConfig? requestConfig}) async {
    return nullIfNotFound(
      (RequestConfig requestConfig) async {
        var response = await _tbClient.delete<Map<String, dynamic>>(
  ...
  Future<Dashboard?> updateDashboardCustomers(
      String dashboardId, Set<String> customerIds,
      {RequestConfig? requestConfig}) async {
    return nullIfNotFound(
      (RequestConfig requestConfig) async {
        var response = await _tbClient.post<Map<String, dynamic>>(
            '/api/dashboard/$dashboardId/customers',
            data: jsonEncode(customerIds),
            options: defaultHttpOptionsFromConfig(requestConfig));
        return response.data != null
            ? Dashboard.fromJson(response.data!)
            : null;
  ...
  Future<Dashboard?> addDashboardCustomers(
      String dashboardId, Set<String> customerIds,
      {RequestConfig? requestConfig}) async {
    return nullIfNotFound(
      (RequestConfig requestConfig) async {
  ...
  Future<Dashboard?> removeDashboardCustomers(
      String dashboardId, Set<String> customerIds,
      {RequestConfig? requestConfig}) async {
    return nullIfNotFound(
      (RequestConfig requestConfig) async {
  ...
  Future<Dashboard?> assignDashboadToEdge(String edgeId, String dashboardId,
      {RequestConfig? requestConfig}) async {
    return nullIfNotFound(
      (RequestConfig requestConfig) async {
        var response = await _tbClient.post<Map<String, dynamic>>(
  ...
  Future<Dashboard?> unassignDashboardFromEdge(
      String edgeId, String dashboardId,
      {RequestConfig? requestConfig}) async {
    return nullIfNotFound(
      (RequestConfig requestConfig) async {
        var response = await _tbClient.delete<Map<String, dynamic>>(
  ...
  Future<PageData<DashboardInfo>> getEdgeDashboards(
